...
from pace_gradients import get_model_tokenizer, get_baseline_embedding
...
def run_single_example(question, context, model_name, a, b, steps,
    ...
    # eval_base_token_emb replaces base_token_emb from the result
